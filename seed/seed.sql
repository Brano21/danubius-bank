...
INSERT INTO cards (account_id, card_number, card_holder, expiry, cvv, status, is_vip) VALUES
  (1, '4917100012340011', 'JAN NOVAK',        '11/27', '221', 'active',  FALSE),
  (2, '4917100012340029', 'MARIA HORVATHOVA', '03/26', '804', 'active',  FALSE),
  (3, '4917100099998888', 'PETER KOVAC',      '09/28', '311', 'active',  TRUE),   -- VIP card, W1-02 target
  (4, '5355220011223344', 'SPRAVCA',          '01/27', '999', 'blocked', FALSE),
